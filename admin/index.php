...
<head>
    ...
    <title>Syaliba Hotel - Admin</title>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li><a class="active-menu" href="index.php?halaman=kamar"><i class="fa fa-tags"></i> Kamar</a></li>
                    <li><a class="active-menu" href="index.php?halaman=reservasi"><i class="fa fa-shopping-cart"></i> Reservasi</a></li>
