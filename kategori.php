...
<?php 
	...
	$kategori = $_GET["id"];
	$semuadata=array();
	$ambil=$koneksi->query("SELECT*FROM kamar WHERE id_kategori LIKE '%$kategori%'");
...
?>
<?php 
	$am= $koneksi->query("SELECT * FROM kategori where id_kategori='$kategori'");
	$pe=$am->fetch_assoc()
?>
...
<body>
	<div class="container">
		...
		<?php if (empty($semuadata)): ?>
			<div class="alert alert-danger">Kamar <strong><?php echo  $pe["nama_kategori"]?></strong> Kosong</div>
