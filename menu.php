<style type="text/css">
  ...
  @media all and (max-width: 900px) {
    ...
    nav ul li.items:hover {
      border-radius: 5px;
      box-shadow: inset 0 0 5px #f5aeaf,
        inset 0 0 10px #ebb5bd;
    }
...
<nav>
  <ul>
    ...
    if (isset($_SESSION["pelanggan"])) : ?>
      <li 
        class="items">
        <a href="riwayat.php">Riwayat Reservasi</a></li>
      <li 
        class="items">
      ...
      <li 
        class="items">
        <a href="profil.php"><img src="fotoprofil/<?php echo $pecah["fotoprofil"] ?>" width="22px" style="border-radius: 15px; -moz-border-radius:15px; border: 2px solid crimson;"></a></li>
    <?php else : ?>
      <li 
        class="items">
