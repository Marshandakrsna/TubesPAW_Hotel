			...
			<div class="modal-dialog">
				...
				<div class="modal-content"><br><br>
					...
					<form method="post" enctype="multipart/form-data" style="padding:25px;">
						...
						<div class="form-group">
							...
							<textarea 
								class="form-control" 
								name="alamat" 
								value="<?php echo $pecah["alamat"] ?>"></textarea>
					...
					if (isset($_POST["ubah"])) {
						...
						if (!empty($lokasifoto)) {
							move_uploaded_file($lokasifoto, "fotoprofil/$foto");
							...
							alamat='$alamat', 
							fotoprofil='$foto' where id_pelanggan='$id_pelanggan'");
						} else {

							$koneksi->query("UPDATE pelanggan SET n
							ama_pelanggan='$nama', 
							email_pelanggan='$email', 
							password_pelanggan='$password', 
							telepon_pelanggan='$telepon',  
